#!/bin/bash
# Batch setup script for Other category
...
REPOS=(
  "Android_Pinnacle|https://github.com/akaash-nigam/Android_Pinnacle.git|premium lifestyle and luxury services platform|Premium User|Concierge|Service Provider|luxury-services|premium-lifestyle|concierge|vip"
  "android_PhoneGuardian|https://github.com/akaash-nigam/android_PhoneGuardian.git|phone security and privacy protection platform|User|Admin|Security Expert|phone-security|privacy-protection|device-security|android-security"
)

echo "========================================"
echo "OTHER CATEGORY SETUP"
