#!/bin/bash
# Batch setup script for Finance & Payment category
...
REPOS=(
  "android_bachat-sahayak|https://github.com/akaash-nigam/android_bachat-sahayak.git|savings groups and community finance management platform|Member|Organizer|Saver|microfinance|savings-groups|community-finance|india"
  "android_KisanPay|https://github.com/akaash-nigam/android_KisanPay.git|farmer payment and agricultural transaction platform|Farmer|Buyer|Agent|agri-payments|farmer-finance|agricultural-transactions|india"
  "android_SafeCalc|https://github.com/akaash-nigam/android_SafeCalc.git|secure calculator and financial privacy vault application|User|Admin|Auditor|privacy|calculator|secure-vault|financial-tools"
)

echo "========================================"
echo "FINANCE & PAYMENT CATEGORY SETUP"
...
echo "========================================"
echo "✅ FINANCE & PAYMENT CATEGORY COMPLETE!"
