# Contributing to Bolo Care

Thank you for your interest in contributing to Bolo Care!
...
```bash
git clone https://github.com/YOUR_USERNAME/bolocare.git
cd bolocare
```
...
```bash
git remote add upstream https://github.com/axion/bolocare.git
```
...
Contact the maintainers or email support@bolocare.com
