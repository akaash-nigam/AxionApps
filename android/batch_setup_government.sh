#!/bin/bash
# Batch setup script for Government & Services category
...
REPOS=(
  "android_sarkar-seva|https://github.com/akaash-nigam/android_sarkar-seva.git|government services and civic platform for accessing public services|Citizen|Official|Administrator|government-services|civic-engagement|public-services|india"
  "android_ayushman-card-manager|https://github.com/akaash-nigam/android_ayushman-card-manager.git|ayushman bharat health card management and health scheme platform|Beneficiary|Health Worker|Administrator|healthcare|health-insurance|government-scheme|india"
  "android_MeraShahar|https://github.com/akaash-nigam/android_MeraShahar.git|civic engagement platform for city services and complaint management|Citizen|Municipal Officer|Admin|civic-tech|city-services|complaint-management|india"
  "android_village-job-board|https://github.com/akaash-nigam/android_village-job-board.git|rural employment and job opportunities platform for villages|Job Seeker|Employer|Coordinator|rural-employment|job-board|village-development|india"
)

echo "========================================"
echo "GOVERNMENT & SERVICES CATEGORY SETUP"
...
echo "========================================"
echo "✅ GOVERNMENT & SERVICES CATEGORY COMPLETE!"
echo "All 4 repositories configured"
echo "========================================"
