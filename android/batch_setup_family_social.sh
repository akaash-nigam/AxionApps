#!/bin/bash
# Batch setup script for Family & Social category
...
REPOS=(
  "Android_FamilyHub|https://github.com/akaash-nigam/Android_FamilyHub.git|family management and coordination platform for shared activities|Family Member|Parent|Child|family-management|coordination|shared-activities|household"
  "android_ShadiConnect|https://github.com/akaash-nigam/android_ShadiConnect.git|matrimonial platform connecting individuals for marriage|User|Match|Family|matrimony|matchmaking|wedding|india"
  "android_FanConnect|https://github.com/akaash-nigam/android_FanConnect.git|fan community and celebrity engagement platform|Fan|Creator|Manager|community|fan-engagement|celebrity|social-network"
)

echo "========================================"
echo "FAMILY & SOCIAL CATEGORY SETUP"
...
echo "========================================"
echo "✅ FAMILY & SOCIAL CATEGORY COMPLETE!"
