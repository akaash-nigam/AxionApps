...
1. **Create board:** "Personal-Finance-Navigator Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "Personal-Finance-Navigator Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Accountant, Both)
...
**Repository name:** `visionOS_Personal-Finance-Navigator`

**Description:**
```
Personal-Finance-Navigator - visionOS app Personal finance management and planning platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_personal-finance-navigator")
