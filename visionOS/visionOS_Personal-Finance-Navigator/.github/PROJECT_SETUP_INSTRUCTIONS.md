...
```
https://github.com/akaash-nigam/visionOS_Personal-Finance-Navigator/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_Personal-Finance-Navigator
...
1. In the "Project name" field, enter:
   ```
   Personal-Finance-Navigator Development
   ```

2. (Optional) Add description:
   ```
   Project management board for Personal-Finance-Navigator visionOS app development
   ```
...
- **User Type** (Worker/Accountant/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_Personal-Finance-Navigator/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_Personal-Finance-Navigator/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_Personal-Finance-Navigator/issues/[NUM]"
```
