#!/bin/bash
# Script to set up GitHub labels for Personal-Finance-Navigator project
...
create_label "user: user" "c5f7c4" "Related to Users"
create_label "user: accountant" "ffd8b1" "Related to Accountants"
create_label "user: advisor" "e3f2fd" "Related to Advisors"
