...
1. **Create board:** "digital twin orchestrator Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "digital twin orchestrator Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Operator, Both)
...
**Repository name:** `visionOS_digital-twin-orchestrator`

**Description:**
```
digital twin orchestrator - visionOS app Digital twin management and orchestration platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_digital-twin-orchestrator")
