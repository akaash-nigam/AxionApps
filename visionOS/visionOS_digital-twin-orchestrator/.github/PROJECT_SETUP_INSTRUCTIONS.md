...
```
https://github.com/akaash-nigam/visionOS_digital-twin-orchestrator/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_digital-twin-orchestrator
...
1. In the "Project name" field, enter:
   ```
   digital twin orchestrator Development
   ```

2. (Optional) Add description:
   ```
   Project management board for digital twin orchestrator visionOS app development
   ```
...
- **User Type** (Worker/Operator/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_digital-twin-orchestrator/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_digital-twin-orchestrator/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_digital-twin-orchestrator/issues/[NUM]"
```
