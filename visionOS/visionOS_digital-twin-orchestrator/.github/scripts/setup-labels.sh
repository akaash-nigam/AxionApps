#!/bin/bash
# Script to set up GitHub labels for digital twin orchestrator project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_digital-twin-orchestrator"
...
create_label "user: engineer" "c5f7c4" "Related to Engineers"
create_label "user: operator" "ffd8b1" "Related to Operators"
