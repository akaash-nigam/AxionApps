...
2. (Optional) Add description:
   ```
   Project management board for business-operating-system visionOS app development
   ```
...
- **User Type** (Worker/Analyst/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_business-operating-system/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_business-operating-system/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_business-operating-system/issues/[NUM]"
```
