#!/bin/bash
# Script to set up GitHub labels for business-operating-system project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_business-operating-system"
...
create_label "user: executive" "c5f7c4" "Related to Executives"
create_label "user: analyst" "ffd8b1" "Related to Analysts"
create_label "user: manager" "e3f2fd" "Related to Managers"
