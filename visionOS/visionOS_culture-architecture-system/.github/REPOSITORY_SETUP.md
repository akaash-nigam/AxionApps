...
1. **Create board:** "culture-architecture-system Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "culture-architecture-system Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Executive, Both)
...
**Repository name:** `visionOS_culture-architecture-system`

**Description:**
```
culture-architecture-system - visionOS app Organizational culture and architecture platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_culture-architecture-system")
