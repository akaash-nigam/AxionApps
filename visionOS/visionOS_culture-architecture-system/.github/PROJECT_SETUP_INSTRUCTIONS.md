...
```
https://github.com/akaash-nigam/visionOS_culture-architecture-system/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_culture-architecture-system
...
1. In the "Project name" field, enter:
   ```
   culture-architecture-system Development
   ```

2. (Optional) Add description:
   ```
   Project management board for culture-architecture-system visionOS app development
   ```
...
- **User Type** (Worker/Executive/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_culture-architecture-system/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_culture-architecture-system/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_culture-architecture-system/issues/[NUM]"
```
