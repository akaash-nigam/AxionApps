#!/bin/bash
# Script to set up GitHub labels for culture-architecture-system project
...
create_label "user: manager" "c5f7c4" "Related to Managers"
create_label "user: executive" "ffd8b1" "Related to Executives"
create_label "user: hr" "e3f2fd" "Related to HRs"
