...
1. **Create board:** "Language-Immersion-Rooms Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "Language-Immersion-Rooms Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Native Speaker, Both)
...
**Repository name:** `visionOS_Language-Immersion-Rooms`

**Description:**
```
Language-Immersion-Rooms - visionOS app Immersive language learning environment
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_language-immersion-rooms")
