#!/bin/bash
# Script to set up GitHub labels for Language-Immersion-Rooms project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_Language-Immersion-Rooms"
...
create_label "user: learner" "c5f7c4" "Related to Learners"
create_label "user: native speaker" "ffd8b1" "Related to Native Speakers"
create_label "user: teacher" "e3f2fd" "Related to Teachers"
