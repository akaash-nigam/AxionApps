...
```
https://github.com/akaash-nigam/visionOS_Language-Immersion-Rooms/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_Language-Immersion-Rooms
...
1. In the "Project name" field, enter:
   ```
   Language-Immersion-Rooms Development
   ```

2. (Optional) Add description:
   ```
   Project management board for Language-Immersion-Rooms visionOS app development
   ```
...
- **User Type** (Worker/Native Speaker/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_Language-Immersion-Rooms/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_Language-Immersion-Rooms/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_Language-Immersion-Rooms/issues/[NUM]"
```
