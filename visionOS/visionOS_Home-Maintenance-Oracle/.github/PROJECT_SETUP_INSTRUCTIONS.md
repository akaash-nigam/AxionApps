...
```
https://github.com/akaash-nigam/visionOS_Home-Maintenance-Oracle/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_Home-Maintenance-Oracle
...
1. In the "Project name" field, enter:
   ```
   Home-Maintenance-Oracle Development
   ```

2. (Optional) Add description:
   ```
   Project management board for Home-Maintenance-Oracle visionOS app development
   ```
...
- **User Type** (Worker/Inspector/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_Home-Maintenance-Oracle/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_Home-Maintenance-Oracle/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_Home-Maintenance-Oracle/issues/[NUM]"
```
