...
This directory contains GitHub Actions workflows for automated CI/CD of the Home-Maintenance-Oracle visionOS app.
...
1. Generate a keystore:
   ```bash
   keytool -genkey -v -keystore release-keystore.jks -keyalg RSA -keysize 2048 -validity 10000 -alias visionos_home-maintenance-oracle
   ```
...
3. Add GitHub Secrets (Settings → Secrets and variables → Actions):
   ...
   - `KEY_ALIAS`: Key alias (e.g., "visionos_home-maintenance-oracle")
...
```markdown
![visionOS CI](https://github.com/akaash-nigam/visionOS_Home-Maintenance-Oracle/workflows/visionOS%20CI/badge.svg)
```
