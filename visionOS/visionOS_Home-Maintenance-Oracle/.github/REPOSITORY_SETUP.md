...
1. **Create board:** "Home-Maintenance-Oracle Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "Home-Maintenance-Oracle Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Inspector, Both)
...
**Repository name:** `visionOS_Home-Maintenance-Oracle`

**Description:**
```
Home-Maintenance-Oracle - visionOS app Home maintenance guidance and scheduling platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_home-maintenance-oracle")
