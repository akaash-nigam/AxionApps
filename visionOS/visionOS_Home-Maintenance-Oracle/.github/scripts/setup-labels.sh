#!/bin/bash
# Script to set up GitHub labels for Home-Maintenance-Oracle project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_Home-Maintenance-Oracle"
...
create_label "user: homeowner" "c5f7c4" "Related to Homeowners"
create_label "user: inspector" "ffd8b1" "Related to Inspectors"
create_label "user: contractor" "e3f2fd" "Related to Contractors"
