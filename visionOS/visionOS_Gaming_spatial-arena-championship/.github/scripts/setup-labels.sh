#!/bin/bash
# Script to set up GitHub labels for Gaming spatial-arena-championship project
...
create_label "user: gamer" "c5f7c4" "Related to Gamers"
create_label "user: spectator" "ffd8b1" "Related to Spectators"
create_label "user: organizer" "e3f2fd" "Related to Organizers"
