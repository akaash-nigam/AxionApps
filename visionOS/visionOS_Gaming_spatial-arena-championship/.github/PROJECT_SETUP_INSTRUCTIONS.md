...
```
https://github.com/akaash-nigam/visionOS_Gaming_spatial-arena-championship/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_Gaming_spatial-arena-championship
...
1. In the "Project name" field, enter:
   ```
   Gaming spatial-arena-championship Development
   ```

2. (Optional) Add description:
   ```
   Project management board for Gaming spatial-arena-championship visionOS app development
   ```
...
- **User Type** (Worker/Spectator/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_Gaming_spatial-arena-championship/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_Gaming_spatial-arena-championship/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_Gaming_spatial-arena-championship/issues/[NUM]"
```
