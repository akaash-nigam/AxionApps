...
This directory contains GitHub Actions workflows for automated CI/CD of the Gaming spatial-arena-championship visionOS app.
...
1. Generate a keystore:
   ```bash
   keytool -genkey -v -keystore release-keystore.jks -keyalg RSA -keysize 2048 -validity 10000 -alias visionos_gaming_spatial-arena-championship
   ```
...
3. Add GitHub Secrets (Settings → Secrets and variables → Actions):
   ...
   - `KEY_ALIAS`: Key alias (e.g., "visionos_gaming_spatial-arena-championship")
...
```markdown
![visionOS CI](https://github.com/akaash-nigam/visionOS_Gaming_spatial-arena-championship/workflows/visionOS%20CI/badge.svg)
```
