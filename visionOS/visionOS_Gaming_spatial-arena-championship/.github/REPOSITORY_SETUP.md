...
1. **Create board:** "Gaming spatial-arena-championship Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "Gaming spatial-arena-championship Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Spectator, Both)
...
**Repository name:** `visionOS_Gaming_spatial-arena-championship`

**Description:**
```
Gaming spatial-arena-championship - visionOS app Spatial arena competitive gaming platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_gaming_spatial-arena-championship")
