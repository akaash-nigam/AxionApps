#!/bin/bash
# Script to set up GitHub labels for spatial-meeting-platform project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_spatial-meeting-platform"
...
create_label "user: organizer" "ffd8b1" "Related to Organizers"
create_label "user: presenter" "e3f2fd" "Related to Presenters"
