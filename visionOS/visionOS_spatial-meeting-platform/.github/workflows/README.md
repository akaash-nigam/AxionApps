...
This directory contains GitHub Actions workflows for automated CI/CD of the spatial-meeting-platform visionOS app.
...
1. Generate a keystore:
   ```bash
   keytool -genkey -v -keystore release-keystore.jks -keyalg RSA -keysize 2048 -validity 10000 -alias visionos_spatial-meeting-platform
   ```
...
3. Add GitHub Secrets (Settings → Secrets and variables → Actions):
   ...
   - `KEY_ALIAS`: Key alias (e.g., "visionos_spatial-meeting-platform")
...
```markdown
![visionOS CI](https://github.com/akaash-nigam/visionOS_spatial-meeting-platform/workflows/visionOS%20CI/badge.svg)
```
