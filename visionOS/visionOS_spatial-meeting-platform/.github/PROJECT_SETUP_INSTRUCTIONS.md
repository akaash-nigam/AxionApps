...
```
https://github.com/akaash-nigam/visionOS_spatial-meeting-platform/projects
```

Or manually:
1. Go to: https://github.com/akaash-nigam/visionOS_spatial-meeting-platform
...
1. In the "Project name" field, enter:
   ```
   spatial-meeting-platform Development
   ```

2. (Optional) Add description:
   ```
   Project management board for spatial-meeting-platform visionOS app development
   ```
...
- **User Type** (Worker/Organizer/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_spatial-meeting-platform/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_spatial-meeting-platform/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_spatial-meeting-platform/issues/[NUM]"
```
