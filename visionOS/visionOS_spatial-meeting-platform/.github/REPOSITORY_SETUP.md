...
1. **Create board:** "spatial-meeting-platform Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "spatial-meeting-platform Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Organizer, Both)
...
**Repository name:** `visionOS_spatial-meeting-platform`

**Description:**
```
spatial-meeting-platform - visionOS app Spatial collaboration and meeting platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_spatial-meeting-platform")
