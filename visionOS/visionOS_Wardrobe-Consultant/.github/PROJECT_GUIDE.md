...
This guide provides comprehensive instructions for setting up and using GitHub Projects for Wardrobe-Consultant development.
...
- 🏗️ `user: fashion designer` - Fashion Designers
- 📋 `user: stylist` - NREGA workers
- 👥 `user: all` - All users
...
1. Go to: https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant
2. Click **Projects** tab
3. Click **New project** (green button)
4. Choose **Team backlog** template
5. Name: `Wardrobe-Consultant Development`
6. Click **Create**
...
gh issue list --label bug --json number \
  | jq '.[].number' \
  | xargs -I {} gh project item-add [PROJECT_NUMBER] --owner akaash-nigam --url "https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant/issues/{}"
```
...
📊 VIEW PROJECT
  https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant/projects
