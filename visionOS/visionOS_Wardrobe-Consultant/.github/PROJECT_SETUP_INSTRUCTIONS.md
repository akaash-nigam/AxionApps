...
1. In the "Project name" field, enter:
   ```
   Wardrobe-Consultant Development
   ```

2. (Optional) Add description:
   ```
   Project management board for Wardrobe-Consultant visionOS app development
   ```
...
- **User Type** (Worker/Fashion Designer/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant/issues/[NUM]"
```
