...
This directory contains GitHub Actions workflows for automated CI/CD of the Wardrobe-Consultant visionOS app.
...
1. Generate a keystore:
   ```bash
   keytool -genkey -v -keystore release-keystore.jks -keyalg RSA -keysize 2048 -validity 10000 -alias visionos_wardrobe-consultant
   ```
...
3. Add GitHub Secrets (Settings → Secrets and variables → Actions):
   ...
   - `KEY_ALIAS`: Key alias (e.g., "visionos_wardrobe-consultant")
...
```markdown
![visionOS CI](https://github.com/akaash-nigam/visionOS_Wardrobe-Consultant/workflows/visionOS%20CI/badge.svg)
```
