...
1. **Create board:** "Wardrobe-Consultant Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "Wardrobe-Consultant Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Fashion Designer, Both)
...
**Repository name:** `visionOS_Wardrobe-Consultant`

**Description:**
```
Wardrobe-Consultant - visionOS app AI-powered wardrobe and style management platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_wardrobe-consultant")
