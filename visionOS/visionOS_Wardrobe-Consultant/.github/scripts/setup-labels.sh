#!/bin/bash
# Script to set up GitHub labels for Wardrobe-Consultant project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_Wardrobe-Consultant"
...
create_label "user: fashion designer" "ffd8b1" "Related to Fashion Designers"
create_label "user: stylist" "e3f2fd" "Related to Stylists"
