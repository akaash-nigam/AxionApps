#!/bin/bash
# Script to set up GitHub labels for Spatial-Code-Reviewer project
# Requires: gh CLI (GitHub CLI) installed and authenticated

set -e

REPO="akaash-nigam/visionOS_Spatial-Code-Reviewer"
...
create_label "user: developer" "c5f7c4" "Related to Developers"
create_label "user: team lead" "ffd8b1" "Related to Team Leads"
create_label "user: reviewer" "e3f2fd" "Related to Reviewers"
