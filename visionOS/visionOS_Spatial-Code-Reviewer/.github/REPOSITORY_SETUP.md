...
1. **Create board:** "Spatial-Code-Reviewer Development"
2. **Columns:**
   - 📋 Backlog
   - 🔜 To Do
   - 🏗️ In Progress
...
1. **Create project:** "Spatial-Code-Reviewer Roadmap"
...
4. **Custom fields:**
   ...
   - User Type (Worker, Team Lead, Both)
...
**Repository name:** `visionOS_Spatial-Code-Reviewer`

**Description:**
```
Spatial-Code-Reviewer - visionOS app Spatial code review and collaboration platform
```
...
3. **KEY_ALIAS**
   - Type: Actions secret
   - Value: Key alias (e.g., "visionos_spatial-code-reviewer")
