...
1. In the "Project name" field, enter:
   ```
   Spatial-Code-Reviewer Development
   ```

2. (Optional) Add description:
   ```
   Project management board for Spatial-Code-Reviewer visionOS app development
   ```
...
- **User Type** (Worker/Team Lead/NREGA/All)
...
**Labels:**
```
https://github.com/akaash-nigam/visionOS_Spatial-Code-Reviewer/labels
```

**Milestones:**
```
https://github.com/akaash-nigam/visionOS_Spatial-Code-Reviewer/milestones
```
...
gh project item-add [PROJECT_NUM] --owner akaash-nigam \
  --url "https://github.com/akaash-nigam/visionOS_Spatial-Code-Reviewer/issues/[NUM]"
```
